...
import com.nantian.ad.LogView.FilterTask;
...
public class LogDialog extends Dialog{
	    ...
	    public LogDialog(Context context)
	    {
	        ...
	        android.widget.FrameLayout.LayoutParams fram_lp = new android.widget.FrameLayout.LayoutParams(LayoutParams.MATCH_PARENT,LayoutParams.MATCH_PARENT);
	        contextText = new TextView(mContext);
	        scrollview.addView(contextText,fram_lp);
	    ...
	    @Override
	    public void show() {
	    	String log = HLog.readLog();
	    	HLog.e("read log", log);
	    	contextText.setText(log);
	    	super.show();

	    }
	    private void initListener()
	    {
	        btnDetele.setOnClickListener(new android.view.View.OnClickListener() {
	        ...
	        btnClr.setOnClickListener(new android.view.View.OnClickListener()
	        {
